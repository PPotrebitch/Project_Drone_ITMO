...
def control_keyboard(settings, key_timeout): # Запуск алгоритма обраьотки сигнала с клавиаиуры 
...
def control_line():  # Запуск алгоритма по линии  
...
if __name__ == "__main__":
    ...
    try:
        ...
        while True:
            ...
            if MODE == 0:
                control_keys[str(MODE)](settings, key_timeout)
            elif MODE == 9:
                control_keys[str(MODE)]()
